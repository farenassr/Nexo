...
public sealed class CreateRestaurantFloorEndpoint(
    ...
    RestaurantSetupService setupService) : Endpoint<CreateRestaurantFloorRequest, RestaurantFloorDetail>
{
    public override void Configure()
    {
        ...
        Summary(summary =>
        {
            summary.Summary = "Create Restaurant Floor";
            summary.Description = "Creates a floor inside a restaurant branch for setup and floor-plan organization.";
        });
    }
